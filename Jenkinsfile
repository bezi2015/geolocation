pipeline {
    ...
    environment {
        registry = '070285518813.dkr.ecr.us-east-1.amazonaws.com/geoloction_ecr_rep'
        dockerimage = '' 
    }
    stages {
        stage('Checkout'){
        ...
        stage('Pushing to ECR') {
            steps{
                script {
                    ...
                    sh 'docker push 070285518813.dkr.ecr.us-east-1.amazonaws.com/geoloction_ecr_rep:latest'
                }
            }
        }
